...
(function() {
  ...
  RetinaImagePath.prototype.check_2x_variant = function(callback) {
    ...
    if (this.is_external()) {
      ...
      http.open('HEAD.html', this.at_2x_path);
